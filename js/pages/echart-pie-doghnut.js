$(function() {
    ...
    var basicpieChart = echarts.init(document.getElementById('basic-pie-startup'));
    var option = {
        // Add title
            ...
            series: [{
                ...
                data: [
                    {value: 60, name: 'MEVP'},
                    {value: 20, name: 'Y Combinator'},
                    {value: 20, name: 'TechStarts'},
        ...
        var option = {
            // Add title
                ...
                series: [{
                    ...
                    center: ['50%', '57.5%'],
                    data: [
                        {value: 60, name: 'Zomato'},
                        {value: 20, name: 'Anghami'},
                        {value: 20, name: 'Toters'},
