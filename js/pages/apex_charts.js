...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#bf4075", "#51ce8a", "#00baff", "#f73838", "#ccff00"],
		tooltip: {
			y: {
				formatter: function(val) {
					return val + "K"
...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#ccff00", "#bf4075", "#f2426d", "#fec801"],
		series: [44, 35, 21]
	}
	var chart = new ApexCharts(
...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#bf4075", "#f73838", "#ccff00","#ff2000"],
		plotOptions: {
			bar: {
				columnWidth: "50%"
			}
	...
	var chart = new ApexCharts(
		document.querySelector("#apexcharts-mixed"), {
			...
			colors: ["#bf4075", "#ff2000", "#ccff00","#fd7e14"],
			series: [{
				name: "Market Average",
				type: "bar",
				data:[23, 11, 22,21],
